...
<div class="col-12">
                <form action="{{ route('usuario.update', $usua->id_usuario) }}" method="post" class="card">
                @method('put')
                @csrf
                  ...
                  <div class="row">
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" placeholder="" value="{{ $usua->nombre_usuario}}">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Apellido paterno</label>
                        <input type="text" class="form-control" name="apePat" placeholder="" value="{{ $usua->apepat_usuario }}">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Apellido materno</label>
                        <input type="text" class="form-control" name="apeMat" placeholder="" value="{{ $usua->apemat_usuario }}">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Correo</label>
                        <input type="email" class="form-control" name="correo" placeholder="" value="{{ $usua->correo_usuario }}">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Contraseña</label>
                        <input type="password" class="form-control" name="contra" placeholder="Contra" value="{{ $usua->contrasenia }}">
                      </div>
                    </div>                 
                    <div class="col-sm-6 col-md-4">
                        <div class = "form-group">
              ...
              <option value = "{{ $usua->id_perfil }}">{{ $usua->nombre_perfil }}</option>
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{ route('usuario.index') }}" class="btn btn-danger ml-auto">Eliminar</a>
                </div>
              </form>
                </div>
              </form>
