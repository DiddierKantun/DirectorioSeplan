...
@section('contenido')
<div class="col-12">
    <form action="{{ Route('sector.update',$sector->id_sector) }}" method="POST" class="card">
        @method('PUT')
        @csrf
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nombre" placeholder="Ingrese el nombre..." value="{{ $sector->nombre_sector }}">
            </div>
        </div>                
        <div class="card-footer text-right">
            <button type="submit" class="btn btn-primary ml-auto">Guardar</button>
            <a href="" class="btn btn-danger ml-auto">Cancelar</a>
        </div>
    </form>
</div>
@stop